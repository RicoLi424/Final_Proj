...
ARCHIVE_OBJS=
ARCHIVE_OBJS += _1517_archive_1.so
_1517_archive_1.so : archive.2/_1517_archive_1.a
	@$(AR) -s $<
	@$(PIC_LD) -shared  -Bsymbolic  -o .//simv.daidir//_1517_archive_1.so --whole-archive $< --no-whole-archive
	@rm -f $@
	@ln -sf .//simv.daidir//_1517_archive_1.so $@
