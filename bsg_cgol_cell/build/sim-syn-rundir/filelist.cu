...
ARCHIVE_OBJS=
ARCHIVE_OBJS += _21436_archive_1.so
_21436_archive_1.so : archive.1/_21436_archive_1.a
	@$(AR) -s $<
	@$(PIC_LD) -shared  -Bsymbolic  -o .//simv.daidir//_21436_archive_1.so --whole-archive $< --no-whole-archive
	@rm -f $@
	@ln -sf .//simv.daidir//_21436_archive_1.so $@
...
CU_UDP_OBJS = \
objs/udps/wizTW.o objs/udps/bNnRR.o 
