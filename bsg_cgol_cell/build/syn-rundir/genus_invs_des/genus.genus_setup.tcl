...
################################################################################
if {[::legacy::find -design design:bsg_cgol_cell] ne ""} {
  puts "** A design with the same name is already loaded. It will be removed. **"
  delete_obj design:bsg_cgol_cell
}
...
# slack
set _slk_ [::legacy::get_attribute slack design:bsg_cgol_cell]
if {[regexp {^-?[0-9.]+$} $_slk_]} {
...
unset _tns_
# cell area
set _cell_area_ [::legacy::get_attribute cell_area design:bsg_cgol_cell]
...
unset _cell_area_
# net area
set _net_area_ [::legacy::get_attribute net_area design:bsg_cgol_cell]
